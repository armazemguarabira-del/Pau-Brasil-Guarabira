...
export const AF_PLANOS: Record<string, PlanoDef> = {
  basico: {
    id:    'basico',
    nome:  'Básico',
    preco: 149,
    periodo: 'mês',
    maxUsuarios: 10,
    descricao: 'Para operações com foco em produção e controle de validade.',
    modulos: ['repack', 'validades'],
  },
  profissional: {
    id:    'profissional',
    nome:  'Profissional',
    ...
    periodo: 'mês',
    maxUsuarios: 20,
    descricao: 'Cobertura completa das operações de armazém e carga.',
    destaque: true,
    modulos: ['repack', 'validades', 'quebras', 'despejo'],
  },
  completo: {
    id:    'completo',
    nome:  'Completo',
    ...
    descricao: 'Todos os módulos. Para distribuidoras com controle logístico completo.',
