...
# Generate July 2026 records (18 for 24/07, 18 for 23/07, 38 for 22/07, 6 for 25/07)
products = [
...
full_dataset = july_25 + july_24 + july_23 + july_22 + user_data
...
print('Successfully wrote', len(full_dataset), 'records to baseQuebrasData.json')
